                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
                                ...
                                <a class="btns" href="mailto:support@task.owl">support@task.owl</a>     
                                <a class="icons" href="tel:+953 012 3654 896">
                                    <span class="lnr lnr-phone-handset"></span>
                                </a>
                                <a class="icons" href="mailto:support@task.owl">
                                    ...
                                    <div class="single-post row">
                                        ...
                                        <div class="col-lg-9 col-md-9 ">
                                            <div class="feature-img">
                                                <img class="img-fluid" src="img/featured/{{ $element->featured_image }}" alt="">
                                            </div>
                                            <a class="posts-title" href="{{ route('news.blog', $element->id) }}"><h3>{{ $element->title }}</h3></a>
                                            <p class="excert">
                                                {{ $element->description }}
                                            </p>
                                            <a href="{{ route('news.blog', $element->id) }}" class="primary-btn">View More</a>
                                        </div>
                                    </div>
                                @endforeach   
                            @endif                                            
