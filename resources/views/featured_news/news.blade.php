							...
							<div class="single-post row">
								...
								<div class="col-lg-3  col-md-3 meta-details">
									...
									<div class="user-details row">
										...
										<p class="date col-lg-12 col-md-12 col-6"><a href="#">{{ $news->created_at }}</a> <span class="lnr lnr-calendar-full"></span></p>
								...
								<div class="col-lg-9 col-md-9">
									<a class="posts-title" href="#"><h3>{{ $news->title }}</h3></a>
									<p class="excert">
										<b>											
											{{ $news->description }}
										</b>
						...
						<div class="col-lg-4 sidebar-widgets">
							<div class="widget-wrap">
								...
								<div class="single-sidebar-widget user-info-widget">
									...
									<a href="#"><h4>{{ $news->author->name }}</h4></a>
									<p>
										Senior blog writer
									</p>
